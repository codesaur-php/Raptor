...
6. [Модулиуд](#6-модулиуд) (6.1-6.13 Суурь | 6.14-6.18 Шинэ: Дэлгүүр, Мэдэгдэл, Хөгжүүлэлт, SEO, Спам хамгаалалт)
...
- **`private/`** - Нууцлалтай файлууд (SQLite DB, upload), deploy хийгдэхгүй
...
|   |   |-- development/           # Хөгжүүлэлтийн хэрэгслүүд (SQL terminal, file manager, error log)
...
**Классууд:** `ProductsController`, `ProductsRouter`, `ProductsModel`, `OrdersController`, `OrdersRouter`, `OrdersModel`
...
- Захиалгын удирдлага - хэрэглэгчийн мэдээлэл, статус хянах
...
- Мэдэгдлийн төрлүүд: хэрэглэгч бүртгүүлсэн, хэрэглэгч зөвшөөрсөн, шинэ захиалга, захиалгын статус өөрчлөлт, контентийн үйлдлүүд
- Өнгөт embed мессеж
...
**Классууд:** `DevelopmentRouter`, `DevRequestController`, `DevRequestModel`, `DevResponseModel`, `SqlTerminalController`, `FileManagerController`

- Хөгжүүлэлтийн хүсэлт хянах систем
- SQL Terminal - өгөгдлийн сангийн query ажиллуулах
- Алдааны лог үзэх
- Файл менежер
...
- Үйлдэл тус бүрийн хурд хязгаарлалт (login 3s, signup 5s, forgot 10s)
- Формын хугацаа дуусах шалгалт (1 цагийн дотор)
- Бөглөх хурдны доод хязгаар (2 секунд)
