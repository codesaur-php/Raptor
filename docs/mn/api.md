...
`Dashboard\Application` нэмдэг: `HomeRouter`, `ShopRouter` (products + orders + reviews), `ManualRouter`, `Protected\ProtectedRouter`, `Badge\BadgeRouter` (sidebar badge систем `application/dashboard/badge/`-д байрлана).
