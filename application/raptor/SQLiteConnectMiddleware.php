 ...
 *
 * Raptor Framework-ийн SQLite холболтын middleware.
 *
 ...
 *   RAPTOR_DB_NAME=/path/to/database.db  (эсвэл :memory: RAM дээр ажиллуулах)
 *
 * @package Raptor
 */
class SQLiteConnectMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        // ---------------------------------------------------------------------
        $database = $_ENV['RAPTOR_DB_NAME'] ?? 'raptor.db';
