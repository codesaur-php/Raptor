...
class TextInitial
{
     ...
     * Энэ текстүүд нь бүх Raptor төслүүдэд нийтлэг ашиглагддаг.
    ...
    public static function localization_text_default(TextModel $model)
    {
        ...
        $model->insert(['keyword' => 'active', 'type' => 'sys-defined'], ['mn' => ['text' => 'Идэвхтэй'], 'en' => ['text' => 'Active']]);
    ...
    public static function localization_text_dashboard(TextModel $model)
    {
        ...
        $model->insert(['keyword' => 'error-log', 'type' => 'sys-defined'], ['mn' => ['text' => 'Алдааны протокол'], 'en' => ['text' => 'Error Log']]);
        $model->insert(['keyword' => 'error-occurred', 'type' => 'sys-defined'], ['mn' => ['text' => 'Алдаа гарлаа'], 'en' => ['text' => 'Error occurred']]);
        $model->insert(['keyword' => 'execute', 'type' => 'sys-defined'], ['mn' => ['text' => 'Ажиллуулах'], 'en' => ['text' => 'Execute']]);
        ...
        $model->insert(['keyword' => 'file-manager', 'type' => 'sys-defined'], ['mn' => ['text' => 'Файлын менежер'], 'en' => ['text' => 'File Manager']]);
        $model->insert(['keyword' => 'file-too-large-preview', 'type' => 'sys-defined'], ['mn' => ['text' => 'Файл хэт том тул зөвхөн 2MB хүртэл харуулж байна'], 'en' => ['text' => 'File too large, showing up to 2MB only']]);
...
$model->insert(['keyword' => 'lines', 'type' => 'sys-defined'], ['mn' => ['text' => 'мөр'], 'en' => ['text' => 'lines']]);
        ...
        $model->insert(['keyword' => 'manage-menu', 'type' => 'sys-defined'], ['mn' => ['text' => 'Цэс удирдах'], 'en' => ['text' => 'Manage Menu']]);
        ...
        $model->insert(['keyword' => 'parent-page-hint', 'type' => 'sys-defined'], ['mn' => ['text' => 'Эцэг хуудас (навигац) - дотроо хүүхэд хуудсуудыг агуулна'], 'en' => ['text' => 'Parent page (navigation) - will contain child pages']]);
        ...
        $model->insert(['keyword' => 'sql-query-placeholder', 'type' => 'sys-defined'], ['mn' => ['text' => 'SQL query бичнэ үү... (Жишээ: SHOW TABLES)'], 'en' => ['text' => 'Write SQL query... (Example: SHOW TABLES)']]);
        $model->insert(['keyword' => 'sql-terminal', 'type' => 'sys-defined'], ['mn' => ['text' => 'SQL Терминал'], 'en' => ['text' => 'SQL Terminal']]);
        ...
        $model->insert(['keyword' => 'title-and-description-required', 'type' => 'sys-defined'], ['mn' => ['text' => 'Гарчиг болон тайлбарыг заавал бөглөнө үү'], 'en' => ['text' => 'Title and description are required']]);
