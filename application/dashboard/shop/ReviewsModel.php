...
class ReviewsModel extends Model
{
    ...
    protected function __initial()
    {
        ...
        $this->exec("CREATE INDEX {$table}_idx_product_active ON $table (product_id, is_active)");
        $this->exec("CREATE INDEX {$table}_idx_product_active_rating ON $table (product_id, is_active, rating)");
