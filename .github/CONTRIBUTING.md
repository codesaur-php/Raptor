...
│   │   ├── authentication/      # Login, JWT, Session, User value object
│   │   ├── content/
│   │   │   ├── file/            # File management (upload, image optimization)
│   │   │   ├── news/            # News module
│   │   │   ├── page/            # Pages module (navigation, content)
│   │   │   ├── reference/       # Reference tables
│   │   │   ├── settings/        # Site settings
│   │   │   ├── AIHelper.php     # OpenAI integration
│   │   │   └── ContentsRouter.php
│   │   ├── exception/           # Error & exception handlers
│   │   ├── localization/
...
│   │   ├── template/            # Dashboard UI (layout, menu)
│   │   ├── user/                # User management
│   │   ├── Application.php      # Raptor bootstrap
...
│   │   ├── moedit/              # WYSIWYG editor
│   │   └── motable/             # Table component
│   ├── public/                  # User-uploaded files
│   └── index.php                # Entry point
├── docs/
│   ├── conf.example/            # .env, .htaccess, nginx config examples
│   ├── en/                      # English documentation
│   └── mn/                      # Mongolian documentation
├── logs/                        # Error & application logs
├── private/                     # Protected files (not web-accessible)
