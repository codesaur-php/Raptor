...
class RBACController extends DashboardController
{
    ...
    public function alias()
    {
        try {
            ...
            if ($alias == 'system'
                ...
                $this->indo('/statement', ['query' => $query]);
                $permissions = $this->indo('/statement', $payload);
            }
    ...
    public function viewRole()
    {
        try {
            ...
            $role_result = $this->indo('/statement', [
    ...
    public function setUserRole(int $id)
    {
        try {
            ...
            if ($is_submit) {
                ...
                $organizations_result = $this->indo('/statement', ['query' => $organizations_query]);
